<div class="page-header">
  ...
  <h1>Quick Start</h1>
  <p class="page-subtitle">Get the Fundsroom Mini ERP + CRM Operations Portal running on your local machine in minutes.</p>
...
::: tip READY TO GO
The application is now accessible at `http://localhost:5173`. You can log in using the seeded admin credentials (`admin@fundsroom.com`).
:::
